...
from models.transforms_img_embedding import _transform
...
class Img_Embedding(nn.Module):
    ...
    def __init__(self,clip_version="ViT-L/14",img_resolution=224,img_data_dir='/public/home/dzhang/pyProject/hytian/ChineseBert_ADD_PIC_WEIBO/weibo_dataset'):
    ...
    def forward(self, img_paths_list):
        ...
        for img_paths in img_paths_list:
            ...
            img_len_list.append(clip_feats.shape[0])
        ...
        return batch_clip_feats, img_len_list
